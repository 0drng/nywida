...
impl From<CommandError> for PackageManagerError {
    fn from(value: CommandError) -> Self {
        match value {
            CommandError::UserAbort(labels, params) => PackageManagerError::InstallFailed(labels, params),
            CommandError::CommandFailed(labels, params) => PackageManagerError::InstallFailed(labels, params),
        }
    }
}
